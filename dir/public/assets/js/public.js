        ...
        fetch('https://api.github.com/repos/just-seb03/project_path/commits')
            ...
            .then(data => {
                ...
                if (Array.isArray(data)) {
                    ...
                    commitsContainer.innerHTML = '<div class="glass-card-info"><p>Error al cargar los commits.</p></div>';
                }
            })
            .catch(error => {
                commitsContainer.innerHTML = '<div class="glass-card-info"><p>Error de conexión con GitHub.</p></div>';
            });
    }
}